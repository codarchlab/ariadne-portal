<div class="row hit-external">
    <div class="col-md-11 hit" onclick="window.location.href = '{{ route('resource.page', $hit['_id']) }}'">
    ...
    <div class="col-md-1 hit">
         @if (isset($hit['_source']['landingPage']))        
            <a class="button" href="{{ $hit['_source']['landingPage']}}" target="_blank">
