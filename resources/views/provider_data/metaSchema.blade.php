            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header" title="">
                        ...
                        <div class="box-tools pull-right">Added: {{ date("Y-m-d", strtotime($metaSchema->cr_tstamp)) }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        @endif
                        @if (isset($metaSchema->properties['creator']) || isset($metaSchema->properties['owner']) || isset($metaSchema->properties['publisher']) || isset($metaSchema->properties['usedby']) ||
                         ...
                         <div class="tab-pane active" id="tab_general">
                            <div class="row" style="padding: 14px;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @foreach($metaSchema->properties['originalId'] as $value)
                                    <p>{{ $value }}</p>
                                    @endforeach 
                                </div>
                                @endif
                    ...
                    @if (isset($metaSchema->properties['keyword']) || isset($metaSchema->properties['subject']) )  
                        ...
                        isset($metaSchema->properties['legalResponsible']) || isset($metaSchema->properties['scientificResponsible']) || isset($metaSchema->properties['technicalResponsible'])|| isset($metaSchema->properties['usedby']))           
                        ...
                        <div class="tab-pane" id="tab_ownership">
                            <div class="row" style="padding: 14px;">
                                ...
                                @if (isset($metaSchema->properties['usedby'])) 
                                <div class="col-md-12">
                                    <b>Used by</b>
                                    @foreach($metaSchema->properties['usedby'] as $value)
                                    <p>{{ $value }}</p>
                                    @endforeach
                                </div>
                                @endif     
