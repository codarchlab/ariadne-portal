@extends('app')
@section('title', 'Error - Ariadne portal')
...
<div class="container content">
    <div class="row">
        <div class="col-md-10 col-md-offset-1 text-center error-title">
            ...
            <p>
                Unfortunately we couldn't find what you are looking for. Try searching the portal. An email was sent to report the issue.
            </p>
        </div>
    </div>
