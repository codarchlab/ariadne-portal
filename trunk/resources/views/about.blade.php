                        ...
                        <div class="box-group" id="accordion">
                            <div class="panel box box-warning">
                                <div class="box-header">
                                    <h4 class="box-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="">
                                            Ariadne project and the registry
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapseOne" class="panel-collapse in" style="height: auto;">
                                    <div class="box-body">
                                        ...
                                        <h4>Ariadne Metadata Registry</h4>
                            ...
                            <div class="panel box box-danger">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse" style="height: 0px;">
                                    <div class="box-body">
                                        <p align="justify">
                                            ACDM is an extension of the <a href="http://www.w3.org/TR/vocab-dcat/" target='_blank'> <b>Data Catalog Vocabulary (DCAT) </b> </a>, a quasi-recommendation of the W3C Consortium
                                        ...
                                        <h4>Class structure of the model </h4>
                                        <p align="justify">
